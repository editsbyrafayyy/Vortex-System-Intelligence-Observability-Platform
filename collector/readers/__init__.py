...
from .cpu      import get_raw_ticks, read_cpu_stats
from .memory   import read_memory_stats
from .disk     import _get_disk_snapshot
from .network  import _get_net_snapshot
from .processes import _get_process_snapshot
